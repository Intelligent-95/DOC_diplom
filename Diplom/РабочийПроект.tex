...
\begin{xltabular}{\textwidth}{|l|X|}
	\caption{Методы модуля db\_utils}\label{dbutils:table} \\ \hline
	\centrow Метод & \centrow Описание \\ \hline
	\endfirsthead
	
	\continuecaption{Продолжение таблицы \ref{dbutils:table}}
	\centrow Метод & \centrow Описание \\ \hline
	\finishhead
...
\begin{xltabular}{\linewidth}{|X|X|X|}
	...
	\continuecaption{Продолжение таблицы \ref{usermodel-tests}}
	\centrow Название теста (функция) & \centrow Входные данные & \centrow Выходные данные \\ \hline
	\finishhead
...
\begin{xltabular}{\linewidth}{|X|X|X|}
	...
	\continuecaption{Продолжение таблицы \ref{groupmodel-tests}}
	\centrow Название теста (функция) & \centrow Входные данные & \centrow Выходные данные \\ \hline
	\finishhead
...
\begin{xltabular}{\linewidth}{|X|X|X|}
	...
	\continuecaption{Продолжение таблицы \ref{messagemodel-tests}}
	\centrow Название теста (функция) & \centrow Входные данные & \centrow Выходные данные \\ \hline
	\finishhead
